...
export const Icons = {
  ...
  [IconTypes.Bars2]: (color: string, props: IconProps = {}) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  [IconTypes.Edit]: (color: string, props: IconProps = {}) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  [IconTypes.Eye]: (color: string, props: IconProps = {}) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  [IconTypes.Refresh]: (color: string, props: IconProps = {}) => {
    return (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
